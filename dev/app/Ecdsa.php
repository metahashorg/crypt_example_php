...
class Ecdsa
{
	...
	public function getAdressTest($key)
	{
		$code = '';
		...
		$code = $this->hex2bin_custom($code);
		//echo $code."<br>";
		echo 'step 1 => '.bin2hex($code)."<br>";
		$code = hash('sha256', $code);
		echo 'step 2 => '.$code."<br>";
		$code = $this->hex2bin_custom($code);
		$code = hash('ripemd160', $code);
		echo 'step 3 => '.$code."<br>";
		$code = '00'.$code;
		echo 'step 4 => '.$code."<br>";

		$code = $this->hex2bin_custom($code);
		$hash_summ = hash('sha256', $code);
		echo 'step 5 => '.$hash_summ."<br>";
		$hash_summ = $this->hex2bin_custom($hash_summ);
		$hash_summ = hash('sha256', $hash_summ);
		echo 'step 6 => '.$hash_summ."<br>";
		$hash_summ = substr($hash_summ, 0, 8);
		echo 'step 7 => '.$hash_summ."<br>";
		
		$code = bin2hex($code).$hash_summ;
		echo 'step 8 => '.$code."<br>";
		echo 'step 9 => 0x'.$code."<br>";
